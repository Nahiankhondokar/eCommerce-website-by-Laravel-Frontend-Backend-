...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">You are receiving this email because you order some product form easy online shop</p>
...
<td>Invoice No : <strong>{{ $mail_data['invoice_no'] }}</strong></td>
<td>Amount : <strong>{{ $mail_data['amount'] }}</strong></td>
<td>Name : <strong>{{ $mail_data['name'] }}</strong></td>
<td>Email : <strong>{{ $mail_data['email'] }}</strong></td>
