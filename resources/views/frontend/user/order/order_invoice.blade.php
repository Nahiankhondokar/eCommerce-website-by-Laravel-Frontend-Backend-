    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           @php
               ...
               $state    = $order -> stateName -> state_name;
           @endphp

           <strong>Address:</strong> {{$division}}, {{ $district }}, {{ $state ?? 'None'}} <br>
        ...
        <td>
          <p class="font">
            ...
            Delivery Date: {{ $order -> post_code }} <br>
  ...
  <table width="100%">
    ...
    <tbody>
      ...
      @foreach($orderItem as $item)
        <tr class="font">
          <td align="center">
            <img src="/media/admin/products/tham-nail/{{ $item -> product -> product_thamnail }}" alt="" style="width: 50px; height: 50px;">
          </td>
