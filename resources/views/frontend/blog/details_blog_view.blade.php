...
@section('title')
{{ $blogPost -> blog_categroy_name_eng }}
@endsection
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="#">Home</a></li>
				<li class='active'>{{ $blogPost -> blog_categroy_name_eng }}</li>
			</ul>
			...
			<div class="blog-page">
				<div class="col-md-9">
					<div class="blog-post wow fadeInUp">
						...
						<h1>@if(Session() -> get('language') == 'hindi') {{ $blogPost -> post_title_hin }} @else {{ $blogPost -> post_title_eng }}@endif</h1>
