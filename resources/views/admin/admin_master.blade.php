	  ...
	  <div class="container-full">
		...
		<section class="content">
			<div class="row">
				...
				<div class="col-xl-6 col-12">
					<div class="box bg-info bg-img" style="background-image: url(backend/images/gallery/bg-1.png)">
						<div class="box-body text-center">							
							<img src="backend/images/trophy.png" class="mt-50" alt="" />
					...
					<div class="box overflow-hidden">
						<div class="box-body p-0">
							<div class="row no-gutters">
								...
								<div class="col-md-6 col-12">
									<div class="box no-shadow mb-0 bg-img rounded-0" data-overlay="5" style="background-image: url(backend/images/gallery/landscape7.jpg)">
										<div class="box-header no-border">
											<h4 class="box-title mb-0">
          ...
          <div class="media-list media-list-hover mt-20">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-danger" href="#">
				<img src="backend/images/avatar/2.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-warning" href="#">
				<img src="backend/images/avatar/3.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
